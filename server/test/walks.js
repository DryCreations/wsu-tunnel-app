...
const len7 = [
    ...
    {"nodeIDs":[6,7,9,10,12,17,19,20],"edgeIDs":[7,9,10,12,18,21,23]},
    {"nodeIDs":[8,7,9,10,12,17,19,20],"edgeIDs":[8,9,10,12,18,21,23]},
    ...
    {"nodeIDs":[20,19,17,12,10,9,7,6],"edgeIDs":[23,21,18,12,10,9,7]},
    {"nodeIDs":[20,19,17,12,10,9,7,8],"edgeIDs":[23,21,18,12,10,9,8]},
];

const len8 = [
    {"nodeIDs":[1,2,3,5,6,7,9,10,11],"edgeIDs":[1,2,4,6,7,9,10,11]},
    {"nodeIDs":[1,2,3,5,6,7,9,10,12],"edgeIDs":[1,2,4,6,7,9,10,12]},
    {"nodeIDs":[2,3,5,6,7,9,10,12,13],"edgeIDs":[2,4,6,7,9,10,12,14]},
    {"nodeIDs":[2,3,5,6,7,9,10,12,14],"edgeIDs":[2,4,6,7,9,10,12,15]},
    {"nodeIDs":[2,3,5,6,7,9,10,12,15],"edgeIDs":[2,4,6,7,9,10,12,16]},
    {"nodeIDs":[2,3,5,6,7,9,10,12,16],"edgeIDs":[2,4,6,7,9,10,12,17]},
    {"nodeIDs":[2,3,5,6,7,9,10,12,17],"edgeIDs":[2,4,6,7,9,10,12,18]},
    {"nodeIDs":[2,3,5,6,7,9,10,12,18],"edgeIDs":[2,4,6,7,9,10,12,19]},
    {"nodeIDs":[3,5,6,7,9,10,12,17,19],"edgeIDs":[4,6,7,9,10,12,18,21]},
    {"nodeIDs":[4,5,6,7,9,10,12,17,19],"edgeIDs":[5,6,7,9,10,12,18,21]},
    {"nodeIDs":[5,6,7,9,10,12,17,19,20],"edgeIDs":[6,7,9,10,12,18,21,23]},
    {"nodeIDs":[11,10,9,7,6,5,3,2,1],"edgeIDs":[11,10,9,7,6,4,2,1]},
    {"nodeIDs":[12,10,9,7,6,5,3,2,1],"edgeIDs":[12,10,9,7,6,4,2,1]},
    {"nodeIDs":[13,12,10,9,7,6,5,3,2],"edgeIDs":[14,12,10,9,7,6,4,2]},
    {"nodeIDs":[14,12,10,9,7,6,5,3,2],"edgeIDs":[15,12,10,9,7,6,4,2]},
    {"nodeIDs":[15,12,10,9,7,6,5,3,2],"edgeIDs":[16,12,10,9,7,6,4,2]},
    {"nodeIDs":[16,12,10,9,7,6,5,3,2],"edgeIDs":[17,12,10,9,7,6,4,2]},
    {"nodeIDs":[17,12,10,9,7,6,5,3,2],"edgeIDs":[18,12,10,9,7,6,4,2]},
    {"nodeIDs":[18,12,10,9,7,6,5,3,2],"edgeIDs":[19,12,10,9,7,6,4,2]},
    {"nodeIDs":[19,17,12,10,9,7,6,5,3],"edgeIDs":[21,18,12,10,9,7,6,4]},
    {"nodeIDs":[19,17,12,10,9,7,6,5,4],"edgeIDs":[21,18,12,10,9,7,6,5]},
    {"nodeIDs":[20,19,17,12,10,9,7,6,5],"edgeIDs":[23,21,18,12,10,9,7,6]},
];

const len9 = [
    {"nodeIDs":[1,2,3,5,6,7,9,10,12,13],"edgeIDs":[1,2,4,6,7,9,10,12,14]},
    {"nodeIDs":[1,2,3,5,6,7,9,10,12,14],"edgeIDs":[1,2,4,6,7,9,10,12,15]},
    {"nodeIDs":[1,2,3,5,6,7,9,10,12,15],"edgeIDs":[1,2,4,6,7,9,10,12,16]},
    {"nodeIDs":[1,2,3,5,6,7,9,10,12,16],"edgeIDs":[1,2,4,6,7,9,10,12,17]},
    {"nodeIDs":[1,2,3,5,6,7,9,10,12,17],"edgeIDs":[1,2,4,6,7,9,10,12,18]},
    {"nodeIDs":[1,2,3,5,6,7,9,10,12,18],"edgeIDs":[1,2,4,6,7,9,10,12,19]},
    {"nodeIDs":[2,3,5,6,7,9,10,12,17,19],"edgeIDs":[2,4,6,7,9,10,12,18,21]},
    {"nodeIDs":[3,5,6,7,9,10,12,17,19,20],"edgeIDs":[4,6,7,9,10,12,18,21,23]},
    {"nodeIDs":[4,5,6,7,9,10,12,17,19,20],"edgeIDs":[5,6,7,9,10,12,18,21,23]},
    {"nodeIDs":[13,12,10,9,7,6,5,3,2,1],"edgeIDs":[14,12,10,9,7,6,4,2,1]},
    {"nodeIDs":[14,12,10,9,7,6,5,3,2,1],"edgeIDs":[15,12,10,9,7,6,4,2,1]},
    {"nodeIDs":[15,12,10,9,7,6,5,3,2,1],"edgeIDs":[16,12,10,9,7,6,4,2,1]},
    {"nodeIDs":[16,12,10,9,7,6,5,3,2,1],"edgeIDs":[17,12,10,9,7,6,4,2,1]},
    {"nodeIDs":[17,12,10,9,7,6,5,3,2,1],"edgeIDs":[18,12,10,9,7,6,4,2,1]},
    {"nodeIDs":[18,12,10,9,7,6,5,3,2,1],"edgeIDs":[19,12,10,9,7,6,4,2,1]},
    {"nodeIDs":[19,17,12,10,9,7,6,5,3,2],"edgeIDs":[21,18,12,10,9,7,6,4,2]},
    {"nodeIDs":[20,19,17,12,10,9,7,6,5,3],"edgeIDs":[23,21,18,12,10,9,7,6,4]},
    {"nodeIDs":[20,19,17,12,10,9,7,6,5,4],"edgeIDs":[23,21,18,12,10,9,7,6,5]},
];
